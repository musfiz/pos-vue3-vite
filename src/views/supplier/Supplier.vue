    ...
    methods: {
        onSubmit(e){
            ...
            if(this.id){
                ...
                this.axios.put('supplier/'+ this.id, params)
                    .then(({data}) => {
                ...
                this.axios.post('supplier', params)
                    .then(({data}) => {
        ...
        onDelete(item:Object){
            this.axios.delete('supplier/'+ item.id, {'_method': 'DELETE'})
                .then(({data}) => {
                    this.$swal.fire(
                        'Deleted!',
                        data.message,
        ...
        <div class="col">
            <div class="card border-secondary">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5><i class="fa fa-list"></i> Supplier</h5>
                    ...
                    <form autocomplete="off" @submit="onSubmit">                        
                        <div class="row"> 
                             <div class="col-4">
                               ...
                               <input type="text" class="form-control" :class="{'is-invalid': nameError}" placeholder="Supplier Name" v-model="name">
    ...
    <!-- row -->
     ...
     <div class="row mt-2">
        <div class="col">
          <div class="card">
            <div class="card-body">
                <DataTable :url="'/supplier'" :headers="headers" :sort="true" ref="dataTable" @onEdit="onEdit" @onDelete="onDelete"/>
            </div>
          </div>
        </div>
      </div>
